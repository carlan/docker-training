...
#### Summary
We learned how to see the available command of the docker binary.
...
#### Summary
We learned how to run a container, show a list of images and containers.
...
1. Which docker command we use to run a container?
  * [A] ps [B] exec [C] run [D] container

2. Which docker command we use to list the images?
  * [A] img [B] image [C] list [D] images

3. Which docker command we use to list containers?
  * [A] c [B] ps [C] container [D] containers
...
#### Summary
We learned how to download an image from the docker cloud or hub.

#### Questions
1. Which docker command we use to download an image?
  * [A] down [B] pull [C] push [D] download
...
```
Have you noticed some new here?
